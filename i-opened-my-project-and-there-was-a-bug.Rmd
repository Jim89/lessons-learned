...
<aside class="notes">
* Your process is (probably) interesting, but tell your customer the answer
* Then they can decide how much they care about the process
* It doesn't matter if your process was perfect if the answer is inconsequential
* But don't completely abandon a description of process, especially with colleagues
    * As your answer might not be so valid if your process was bad!
</aside>
